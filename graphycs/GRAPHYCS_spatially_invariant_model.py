...
if __name__=="__main__":
    ...
    # parser.add_argument("--base_dir", default="D:\\CAO_Data\\Zemax_sim_study_01202025", type=str)
    ...
    # phase_added_images = phase_added_images[1:]s
    ...
    for epoch_idx in range(n_epochs):
        ...
        for pair_idx in tqdm(range(len(coeffs)), desc="epoch {} optimization".format(epoch_idx)):
            ...
            # epoch_nuclear_loss += nuclear_loss.item()
        ...
        if epoch_idx % 10 == 0:
            ...
            # axs[0, 1].legend(['Predicted', 'Ground Truth'])
