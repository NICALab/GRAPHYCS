...
if __name__=="__main__":
    ...
    for epoch_idx in range(n_epochs):
        ...
        for pair_idx in tqdm(range(len(coeffs)), desc="epoch {} optimization".format(epoch_idx)):
            ...
            psf = fftshift(fft2(ifftshift(amplitude * torch.exp(1j * k * beam_phases_scaled))))
            ...
            aberrated_img = fft_conv(object.unsqueeze(0).unsqueeze(0), psf.unsqueeze(0).unsqueeze(0), None, 0)
