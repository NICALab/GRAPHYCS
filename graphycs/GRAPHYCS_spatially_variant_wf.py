...
if __name__=="__main__":
    ...
    for epoch_idx in t:
        ...
        if epoch_idx % opt.vis_frequency == 0:
            ...
            spatial_mask = beam_crop.unsqueeze(0).repeat(int(opt.num_patches * opt.num_patches), 1, 1).bool()
            ...
            spatial_phase_grid = F.fold(spatial_phase_grid, (opt.num_patches * h_sv, opt.num_patches * w_sv), (h_sv, w_sv), stride=(h_sv, w_sv))
            ...
            save_phase_map_visualization(
                ...
                title='Spatially varying phase components ({}x{} grid)'.format(opt.num_patches, opt.num_patches))
